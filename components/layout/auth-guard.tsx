...
import { getCurrentUser, hasRole, defaultLandingFor, type Role } from '@/lib/auth'
...
export default function AuthGuard({
  ...
  useEffect(() => {
    ...
    // All roles now use the unified /login page
    ...
    if (!hasRole(role)) {
      ...
      router.replace(defaultLandingFor(user.role))
      return
    }
    setReady(true)
