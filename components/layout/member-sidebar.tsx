...
import {
  ...
  ChevronRight, Menu, CalendarCheck, FolderGit2, MessageSquare, BookOpen, Clock
} from 'lucide-react'
...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/member/attendance',  icon: Clock,         label: 'My Attendance' },
...
export function MemberSidebar({ user, children }: MemberSidebarProps) {
      ...
      <div className="px-4 py-3 border-b border-border">
        <Link href="/member/profile" onClick={() => setSidebarOpen(false)}
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-[10px] font-mono text-muted-foreground truncate">{user.role}</p>
          </div>
        </Link>
      </div>
