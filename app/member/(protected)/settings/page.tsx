...
export default function MemberSettingsPage() {
  ...
  function handleSave() {
    ...
    toast({ title: 'Preferences saved', description: 'Your notification preferences have been updated on this device.', type: 'success' })
  }

  function handleDelete() {
    if (!confirm('Sign out and clear locally-stored activity data on this device? This cannot be undone.')) return
    ;[
